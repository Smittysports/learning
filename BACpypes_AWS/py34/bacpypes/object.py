...
from .basetypes import AccessCredentialDisable, AccessCredentialDisableReason, \
    ...
    Polarity, PortHealth, PortPermission, Prescale, PriorityArray, ProcessIdSelection, \
    ...
    RouterEntry, SCHubConnectorState, SCHubConnection, Scale, SecurityKeySet, SecurityLevel, Segmentation, \
...
class NetworkPortObject(Object):
    ...
    properties = \
        ...
        , OptionalProperty('additionalReferencePorts', ListOf(Unsigned) ) #508
        , OptionalProperty('certificateSigningRequestFile', ObjectIdentifier)  #509
        , OptionalProperty('commandValidationResult', PortHealth)  #510
        , OptionalProperty('issuerCertificateFiles', ArrayOf(ObjectIdentifier))  #511
        , OptionalProperty('maxBvlcLengthAccepted', Unsigned)  #4194304
        , OptionalProperty('maxNpduLengthAccepted', Unsigned)  #4194305
        , OptionalProperty('operationalCertificateFile', ObjectIdentifier)  #4194306
        , OptionalProperty('scConnectWaitTimeout', Unsigned)  #4194308
        , OptionalProperty('scDisconnectWaitTimeout', Unsigned)  #4194314
        , OptionalProperty('scFailoverHubConnectionStatus', SCHubConnection)  #4194316
        , OptionalProperty('scPrimaryHubUri', CharacterString)  #4194325
        , OptionalProperty('scFailoverHubUri', CharacterString)  #4194317
        , OptionalProperty('scHubConnectorState', SCHubConnectorState)  #4194318
        , OptionalProperty('scHeartbeatTimeout', Unsigned)  #4194323
        , OptionalProperty('scHeartbeatTimeout', Unsigned)  #4194323
        , OptionalProperty('scPrimaryHubConnectionStatus', SCHubConnection)  #4194324
        , OptionalProperty('scMaximumReconnectTime', Unsigned)  #4194326
        , OptionalProperty('scMinimumReconnectTime', Unsigned)  #4194327
        ]
